...
class SWAV(nn.Module):
    def __init__(
        ...
        add_norm=False,  # Add normalization flag
        ...
        self.add_norm = add_norm  # Store the normalization flag
        ...
        self.checkpoint_name = f"$swav$_{arch}_{output}_{self.return_layers}"
        self.patch_size = 0
