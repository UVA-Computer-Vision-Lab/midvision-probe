...
class SAM(nn.Module):
    def __init__(
        self, arch, output="dense", layer=-1, return_multilayer=False, add_norm=False
    ):
        super().__init__()
        ...
        # Define BatchNorm2d layers for each layer if add_norm is enabled
